class OpenBrowserUse < Formula
  ...
  url "https://github.com/iFurySt/open-codex-browser-use/archive/refs/tags/v0.1.9.tar.gz"
  sha256 "afcf950a28a43ccef1e8053836bd5975f6629701ada52b574a97a61e9350ca00"
  license "MIT"
